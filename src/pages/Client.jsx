      ...
      <div className="reveal presentation">
        <div className="slides" data-transition="slide"> 
          <section data-transition="slide">
            <h1>Client Presentation</h1>
            {console.log(data)}
            <input name="q1" value={data.q1 || ''} onChange={(e) => onChangeInput(e.target.value, e.target.name)}/>
            <input name="q2" value={data.q2 || ''} onChange={(e) => onChangeInput(e.target.value, e.target.name)}/>
          </section>
          <section data-transition="slide">
            <h1>Slide 2</h1>
          </section>
